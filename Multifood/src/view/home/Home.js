...
import { restaurantsSelector,foodsSelector } from '../../redux/selector';
export default function Home({navigation}) {
  const listRestaurant = useSelector(restaurantsSelector);
  const listFood = useSelector(foodsSelector);
  return (
    <ScrollView
      ...
      <View
        ...
        <FlatListProduct  data={listRestaurant}/>
        <View
          style={{
            flexDirection: 'row',
            justifyContent: 'space-between',
